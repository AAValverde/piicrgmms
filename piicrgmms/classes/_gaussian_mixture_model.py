...
class GaussianMixtureModel(GaussianMixtureBase):
    ...
    def cluster_data(self, data_frame_object: object):
        """Use the Gaussian mixture model fit from the sklearn-piicr package to cluster the data.
    ...
    def get_results_fig(self, data_frame_object):
        ...
        for j in range(len(legend_stuff.legend_handles)):
            #legend_stuff.legend_handles[j]._legmarker.set_markersize(10)
